...
/// The callback used by [ReorderableListViewApp] to move an item to a new
/// position in a list.
///
...
/// [ReorderableListViewApp] will need to account for this when inserting before
/// [newIndex].
///
...
class ReorderableListViewApp extends StatefulWidget {
  ...
  /// underlying list.
  ///
  /// This [ReorderableListViewApp] calls [onReorder] after a list child is dropped
  /// into a new position.
  final ReorderCallback onReorder;

  @override
  _ReorderableListViewAppState createState() => _ReorderableListViewAppState();
}
...
class _ReorderableListViewAppState extends State<ReorderableListViewApp> {
  ...
  final GlobalKey _overlayKey =
      GlobalKey(debugLabel: '$ReorderableListViewApp overlay key');
...
class _ReorderableListContentState extends State<_ReorderableListContent>
  ...
  static const double _dropAreaMargin = -10.0;
